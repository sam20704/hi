...
import PyPDF2
from legal_redline_diff_engine import get_legal_redline_for_document
...
async def validate_document(file: UploadFile = File(...)):
    ...
    # Validaton logic - validators folder
    ...
    legal_redline_result = get_legal_redline_for_document(text)
